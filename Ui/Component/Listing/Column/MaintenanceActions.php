...
{
    const URL_PATH_DETAILS = 'xigen_maintenancepage/maintenance/details';
    const URL_PATH_EDIT = 'xigen_maintenancepage/maintenance/edit';
    const URL_PATH_DELETE = 'xigen_maintenancepage/maintenance/delete';
